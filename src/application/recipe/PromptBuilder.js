...
export class PromptBuilder {
  build(input) {
    ...
    const systemPrompt = [
      ...
      'هرگز از مواد غیرغذایی، بهداشتی، جنسی، توهین‌آمیز، خطرناک یا سمی در title، description، ingredients یا instructions استفاده نکنید؛ اگر کاربر چنین موادی داد، آن‌ها را نادیده بگیر و یک غذای ساده و کاملاً خوردنی با مواد مجاز پیشنهاد بده.',
      'برای ورودی‌های شوخی و بی‌ضرر (مثل فقط آب یا آب و نمک) می‌توانید دستور بامزه ولی کاملاً خوردنی بدهید.',
    ].join(' ');
